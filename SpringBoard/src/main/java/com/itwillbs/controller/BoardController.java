...
public class BoardController {
	...
	public String registeGET() throws Exception {
	...
	public String modifPOST(BoardVO vo, RedirectAttributes rttr) throws Exception{
		logger.debug(" /board/bodify -> modifyPOST() 호출");
